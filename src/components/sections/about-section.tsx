import { DownloadIcon, GraduationCapIcon, MapPinIcon, CalendarIcon, CodeIcon } from '../../icons';
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="bg-slate-50 dark:bg-green-900/10 p-6 rounded-xl typewriter-card terminal-card">
                <div className="flex items-center mb-3">
                  <GraduationCapIcon className="text-2xl text-blue-600 dark:text-green-400 mr-3" width={24} height={24} />
              ...
              <div className="bg-slate-50 dark:bg-green-900/10 p-6 rounded-xl typewriter-card terminal-card">
                <div className="flex items-center mb-3">
                  <MapPinIcon className="text-2xl text-cyan-500 dark:text-green-400 mr-3" width={24} height={24} />
          ...
          <div className="space-y-6">
                ...
                {EXPERIENCE.map((exp, index) => (
                  <div key={index} className="flex">
                    <div className="flex-shrink-0 w-12 h-12 bg-blue-600/10 rounded-full flex items-center justify-center mr-4">
                      <CodeIcon className="text-blue-600" width={20} height={20} />
                    </div>
                    <div>
            ...
            <div className="bg-gradient-to-br from-amber-500/5 to-orange-500/5 p-6 rounded-xl">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="flex items-center">
                  <CalendarIcon className="text-amber-500 mr-2" width={16} height={16} />
            ...
            <div className="text-center">
              ...
              >
                <DownloadIcon className="mr-3" width={20} height={20} />
                Download Resume
              </button>
            </div>
          </div>
